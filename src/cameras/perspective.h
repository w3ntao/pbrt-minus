...
PBRT_GPU Vector3 random_in_unit_disk(curandState *local_rand_state) {
    Vector3 p;
    do {
...
class PerspectiveCamera : public Camera {
    public:
        ...
        PBRT_GPU PerspectiveCamera(Point look_from, Point look_at, Vector3 up, double vfov, double aspect,
