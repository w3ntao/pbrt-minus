...
class RGBFilm {
  public:
    PBRT_CPU_GPU void init(Pixel *_pixels, const PixelSensor *_sensor, const Point2i _resolution,
    ...
    PBRT_CPU_GPU RGB get_pixel_rgb(const Point2i p) const {
