...
class Image {
  ...
  public:
    static void write_frame_buffer_to_png(const std::string &file_name, const Color *frame,
    ...
    static Image from_png(const std::string& file_name) {
        auto image = Image(0, 0);
    ...
    void export_to_png(const std::string &file_name) {
